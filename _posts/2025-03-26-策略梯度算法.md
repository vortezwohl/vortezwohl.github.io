...
- 策略梯度定理
  ...
  PG 参数优化基于一个重要的理论基础，即**策略梯度定理**，该定理表明，策略参数 $\theta$ 的梯度 $\nabla_\theta J(\theta)$ 可以表示为在策略 $\pi_\theta$ 下，状态-动作对 $(s,a)$ 的价值函数(期望优势函数)与策略梯度的乘积，其数学表示如下：
  ...
  > 什么是价值函数, [点此查看](https://vortezwohl.github.io/rl/2025/03/25/%E4%BB%80%E4%B9%88%E6%98%AF%E4%BB%B7%E5%80%BC%E5%87%BD%E6%95%B0.html).
